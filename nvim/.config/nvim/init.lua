...
require('lazy').setup({
  ...
  -- Test plugin
  {
    dir = '/Users/alexgrieco/Documents/B_Product_Development/nvim_plugins/stackmap.nvim',
    dev = true,
    name = "stackmap",
    cond = function()
      file = '/Users/alexgrieco/Documents/B_Product_Development/nvim_plugins/stackmap.nvim'
